...
<body class="bg-gray-50 font-sans text-gray-800">
  ...
  $aboutUsImages = isset($settingsRaw['aboutUsImg']) ? json_decode($settingsRaw['aboutUsImg'], true) : [];
  $aboutImage = (!empty($aboutUsImages) && is_array($aboutUsImages)) ? \Illuminate\Support\Facades\Storage::disk('s3')->url($aboutUsImages[0]) : asset('image/cityview.jpg');
  @endphp
